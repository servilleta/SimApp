...
function CookiePolicyPage() {
  ...
  const md = useMarkdown('/legal/COOKIE_POLICY.md');
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <button onClick={() => navigate('/cookie-policy')} style={{ background: 'none', border: 'none', color: 'var(--color-braun-orange)', cursor: 'pointer', padding: 0, marginBottom: '8px', display: 'block' }}>Cookie Policy</button>

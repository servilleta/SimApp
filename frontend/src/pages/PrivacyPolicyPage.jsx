...
// IMPORTANT: In production, replace with dynamic fetch from backend or CDN
...
function PrivacyPolicyPage() {
  ...
  const privacyText = useMarkdown('/legal/PRIVACY_POLICY.md');
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <button onClick={() => navigate('/privacy')} style={{ background: 'none', border: 'none', color: 'var(--color-braun-orange)', cursor: 'pointer', padding: 0, marginBottom: '8px', display: 'block' }}>Privacy Policy</button>
